...
const headCells = [
  ...
  { id: 'Quiz_Score', numeric: true, disablePadding: false, label: 'Quiz Score' },
  { id: 'Comprehensive_Score', numeric: true, disablePadding: false, label: 'Comprehensive Score' },
  { id: 'Total_Score', numeric: true, disablePadding: false, label: 'Total Score' },
                    ...
                    .map((row, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="right">{row.Comprehensive_Score}</TableCell>
